...
/                                                                                                                                        
├── BD_OPORTUNIDADES_23_24.csv .   # Base de datos original con datos crudos archivo .csv                                                ├── CasoTecnicoTecMty.pbix     .   # Dashboard en Power BI que muestra los gráficos y sus resultados.
